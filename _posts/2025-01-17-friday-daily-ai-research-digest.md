...
Keywords: diffusion models, machine writing, large language models, visual tokenizers, generative video models, vision-language-action models, portrait relighting, textured mesh generation
